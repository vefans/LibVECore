 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `VECoreYYModel` protocol for custom methods.
 ...
 @code
     ...
     int main() {
         ...
         YYBook *book = [YYBook veCore_yy_modelWithJSON:@"{\"name\": \"Harry Potter\", \"pages\": 256, \"author\": {\"name\": \"J.K.Rowling\", \"birthday\": \"1965-07-31\" }}"];
 
         // convert model to json
         NSString *json = [book veCore_yy_modelToJSONString];
 ...
 @code
     ...
     - (void)encodeWithCoder:(NSCoder *)aCoder { [self veCore_yy_modelEncodeWithCoder:aCoder]; }
     - (id)initWithCoder:(NSCoder *)aDecoder { self = [super init]; return [self veCore_yy_modelInitWithCoder:aDecoder]; }
     - (id)copyWithZone:(NSZone *)zone { return [self veCore_yy_modelCopy]; }
     - (NSUInteger)hash { return [self veCore_yy_modelHash]; }
     - (BOOL)isEqual:(id)object { return [self veCore_yy_modelIsEqual:object]; }
     @end
 @endcode
 
 */
@interface NSObject (VECoreYYModel)
 ...
 */
+ (nullable instancetype)veCore_yy_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)veCore_yy_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (BOOL)veCore_yy_modelSetWithJSON:(id)json;
...
/**
 ...
 @return Whether succeed.
 */
- (BOOL)veCore_yy_modelSetWithDictionary:(NSDictionary *)dic;
 ...
 */
- (nullable id)veCore_yy_modelToJSONObject;
 ...
 */
- (nullable NSData *)veCore_yy_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)veCore_yy_modelToJSONString;
 ...
 */
- (nullable id)veCore_yy_modelCopy;
 ...
 */
- (void)veCore_yy_modelEncodeWithCoder:(NSCoder *)aCoder;
...
/**
 ...
 @return self
 */
- (id)veCore_yy_modelInitWithCoder:(NSCoder *)aDecoder;
...
/**
 ...
 @return Hash code.
 */
- (NSUInteger)veCore_yy_modelHash;
 ...
 */
- (BOOL)veCore_yy_modelIsEqual:(id)model;
 ...
 */
- (NSString *)veCore_yy_modelDescription;
 ...
 */
@interface NSArray (VECoreYYModel)
 ...
 */
+ (nullable NSArray *)veCore_yy_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (VECoreYYModel)
 ...
 */
+ (nullable NSDictionary *)veCore_yy_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<VECoreYYModel>' to your class header.
 */
@protocol VECoreYYModel <NSObject>
@optional
